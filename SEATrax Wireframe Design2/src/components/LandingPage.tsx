import { Ship, TrendingUp, Users, Clock, DollarSign, FileText, ArrowRight, CheckCircle, Shield, Globe, Eye, Lock } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              <button className="px-4 py-2 text-gray-300 hover:text-white hover-color hover-scale-sm">
                Log In
              </button>
              <button 
                onClick={onGetStarted}
                className="px-6 py-2 bg-cyan-400 text-slate-900 rounded-lg hover:bg-cyan-300 hover-scale-sm hover-shine transition-all border border-cyan-400"
              >
                Sign Up
              </button>
            </div>
